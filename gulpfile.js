...
gulp.task('watch', function() {
	gulp.watch(['app/sass/**/*.sass', 'app/scss/**/*.scss'], gulp.parallel('styles'));
	gulp.watch(['app/js/_custom.js', 'app/js/_libs.js'], gulp.parallel('scripts'));
  gulp.watch('app/pug/**/*.pug', gulp.parallel('pug-compile'));
	gulp.watch('app/html/*.html', gulp.parallel('code'));
	gulp.watch('app/img/_src/**/*', gulp.parallel('img'));
});

gulp.task('default', gulp.parallel('pug-compile', 'img', 'styles', 'scripts', 'browser-sync', 'watch'));
